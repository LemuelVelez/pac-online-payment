import {
  ...
  export const navigationConfig = {
    ...
    cashier: [
      ...
      { name: "Students", href: "/cashier/students", icon: Users },
      { name: "Reports", href: "/cashier/reports", icon: FileText },
      { name: "Settings", href: "/cashier/settings", icon: Settings },
    ],
    "business-office": [
      { name: "Dashboard", href: "/business-office/dashboard", icon: Home },
      { name: "Financial Reports", href: "/business-office/reports", icon: FileText },
      { name: "Collections", href: "/business-office/collections", icon: DollarSign },
      { name: "Budget Management", href: "/business-office/budget", icon: Wallet },
      { name: "Analytics", href: "/business-office/analytics", icon: BarChart4 },
      { name: "Reconciliation", href: "/business-office/reconciliation", icon: ClipboardCheck },
      { name: "Forecasting", href: "/business-office/forecasting", icon: PieChart },
